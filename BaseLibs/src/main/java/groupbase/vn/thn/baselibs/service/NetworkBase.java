 ...
 */
public class NetworkBase implements Network {
    ...
    public NetworkBase ( HttpStack httpStack, ProgressRequestCallBack progressRequestCallBack ) {
...
//    public CustomNetwork(HttpStack httpStack, ByteArrayPool pool) {
//        mHttpStack = httpStack;
//        mPool = pool;
//    }
    @Override
    ...
    private byte[] entityToBytes ( HttpEntity entity ) throws IOException, ServerError {
        ...
        try {
            ...
            if ( mProgressRequestCallBack != null ) {
                mProgressRequestCallBack.onStart( ( int ) entity.getContentLength() );
            }
            while ( (count = in.read( buffer )) != - 1 ) {
                if ( mProgressRequestCallBack != null ) {
                    mProgressRequestCallBack.onUpdate( bytes.size() );
                }
